...
@Module({
  imports: [TypeOrmModule.forRoot(typeOrmConfig), UsersModule, AuthModule, SongsModule, CloudinaryModule, CommentsModule, LikesModule, SongInteractionsModule, RepertoireModule],
  providers: [
    {
      provide: APP_GUARD,
